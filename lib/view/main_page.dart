...
import 'package:bootcamp_project/view/main/discussion/chat_page.dart';
import 'package:bootcamp_project/view/main/profile/profile_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        child: Image.asset(R.assets.icDiscuss,width: 30,),
        onPressed: () {
